...
class Config(ConfigNode):
    @impmagic.loader(
        {'module':'os'},
        {'module':'backend.yaml', 'submodule': ['YamlBackend']},
        {'module':'backend.json', 'submodule': ['JsonBackend']},
        {'module':'backend.toml', 'submodule': ['TomlBackend']},
        {'module':'pathlib', 'submodule': ['Path']},
        {'module':'jinja2', 'submodule': ['Environment', 'FileSystemLoader']},
        {'module':'core.vault_encryption', 'submodule': ['vault_decrypt']},
    )
    def __init__(self, filename, filetype=None, context=None, vault_file=None, vault_keyfile=None, vault_password=None, vault_encryption_keyfile=None, vault_encryption_password=None):
        ...
        if filetype == "yaml":
            ...
            raise ValueError(f"Type de fichier non supporté: {filetype}. Types supportés: yaml, json, toml.")
    ...
    @impmagic.loader(
        ...
        {'module':'core.autoreload', 'submodule': ['_ConfigFileEventHandler']},
    )
